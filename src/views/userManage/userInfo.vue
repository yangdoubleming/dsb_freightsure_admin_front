...
<script>
    ...
    import { getList, downloadExcelForCompanyInfo } from '@/api/userManage'
    ...
    export default {
        ...
        methods: {
            ...
            getExcel(){
                this.listLoading = true
                downloadExcelForCompanyInfo(this.ruleForm).then(response => {
                    this.listLoading = false
                }).catch(err=>{
                    ...
                    let filename = `申请列表${day}.csv`;// 判断是否使用默认文件名
