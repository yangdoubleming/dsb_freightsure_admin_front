<template>
    <section>
        ...
        <el-table :data="tableData" v-loading="listLoading" element-loading-text="Loading" style="width: 100%">
            <el-table-column prop="loanTerm" label="还款期数" width="150"> </el-table-column>
            <el-table-column prop="repaymentAllAmount" label="还款金额" width="280"> </el-table-column>
            <el-table-column prop="repaymentRateAmount" label="偿还利息金额" width=""></el-table-column>
            <el-table-column prop="repaymentTime" label="还款时间" width="" :formatter="dateFormat"> </el-table-column>
            <el-table-column prop="outstandingTerm" label="剩余还款期数" width=""> </el-table-column>
            <el-table-column prop="unpaidPrincipal" label="剩余还款总金额" width=""></el-table-column>
